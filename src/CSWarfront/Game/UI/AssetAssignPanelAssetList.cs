...
namespace CSWarfront.Game.UI
{
    ...
    /// textScale(2倍スケール)、cursorWidth(Int32、2倍スケール)。normalBgSprite/hoveredBgSprite/
    ...
    internal static partial class AssetAssignPanel
    {
        ...
        private static UITextField BuildSearchField(float x, float y, float width)
        {
            ...
            tf.padding = new RectOffset(12, 12, 12, 12); // 旧(6,6,6,6)
        ...
        private static UIDropDown BuildAssetKindDropdown(float x, float y, float width)
        {
            ...
            dd.textScale = 1.5f;
            dd.textFieldPadding = new RectOffset(16, 16, 12, 0);
            dd.itemPadding = new RectOffset(16, 0, 6, 0);
