...
namespace CSWarfront.Core
{
    ...
    public class UnitInstance
    {
        ...
        /// <summary>Task147/148: how long this unit has been deliberately holding a position - under a
        /// player Hold order, or stood down by the AI with no objective (runtime-only, not persisted).
        /// Past FortDefenseBonus.HoursToDigIn it counts as dug in and takes reduced damage: a tank left
        /// on a crossroads has had time to find a berm and a hull-down position. Reset the moment it has
        /// somewhere to be, so the bonus cannot be bought by tapping Hold mid-firefight.</summary>
        public float DugInHours;
