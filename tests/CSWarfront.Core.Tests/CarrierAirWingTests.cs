...
public class CarrierAirWingTests
{
    private static WarState WithCarrier(float treasury, byte unlockedTier = 1, bool registerAirTypes = true)
    {
        ...
        // Task99: 3-resource economy. Give plentiful manpower and zero production so cost is
        // determined solely by the funds balance, as before (funds cost = ProductionCost x 2 = Cost x 0.8 x 2 = Cost x 1.6; Air share = 0.2).
    ...
    public void Full_wing_costs_exactly_the_sum_of_one_of_each_cycle_category_at_Tier1()
    {
        ...
        // Task99: with zero production the funds cost is 750 x 1.6 = 1200 (see the comment in WithCarrier).
